...
public class UsuarioControlador {
    ...
    public String guardar(ModelMap modelo, @RequestParam(required = false) String email,
            @RequestParam(required = false) String nombre, @RequestParam(required = false) String apellido,
            @RequestParam(required = false) Date fechaNacimiento, @RequestParam(required = false) Direccion direccion) {
